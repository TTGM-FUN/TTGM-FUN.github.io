...
this.write("<span> TianTian Learn GO Game</span>");
this.write("</div>");
};
}
...
(function(){var a="",e=document.createElement("style");
a+="div.mxClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentDiv {margin:0 auto 0.5em auto;text-align:center;}"
a+="div.mxClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentContentDiv {display:inline-block;text-align:justify;}"
a+="div.mxClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv {text-align:center;margin:0.75em 0 0.25em 0;}"
a+="div.mxClassicGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button{font-family:Arial,sans-serif;font-size:0.75em;height:auto;min-height:0;border:0;margin:1px;padding:0.25em;color:#000;background:transparent;box-shadow:none;}"
a+="div.mxClassicGlobalBoxDiv.mxProblemGlobalBoxDiv.mxIn3d div.mxSolveDiv button {border:0;box-shadow:2px 2px 6px rgba(0,0,0,0.5);}"
a+="div.mxClassicGlobalBoxDiv.mxProblemGlobalBoxDiv.mxIn2d div.mxSolveDiv button {border:1px solid #999;}"
a+="div.mxClassicGlobalBoxDiv.mxProblemGlobalBoxDiv.mxIn3d div.mxSolveDiv button[disabled] {color:#999;box-shadow:2px 2px 6px rgba(153,153,153,0.5);}"
a+="div.mxClassicGlobalBoxDiv.mxProblemGlobalBoxDiv.mxIn2d div.mxSolveDiv button[disabled] {color:#999;border:1px solid #999;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"Box",c:["Comment","Diagram","Goban","Solve","Version"]};
